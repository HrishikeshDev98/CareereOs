-- CreateEnum
CREATE TYPE "ApplicationStage" AS ENUM ('WISHLIST', 'SAVED', 'APPLIED', 'HR_SCREENING', 'TECHNICAL_ROUND', 'ASSIGNMENT', 'MANAGER_ROUND', 'FINAL_ROUND', 'OFFER', 'ACCEPTED', 'REJECTED', 'WITHDRAWN');
